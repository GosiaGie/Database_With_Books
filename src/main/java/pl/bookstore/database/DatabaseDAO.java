...
public interface DatabaseDAO {
    ...
    ArrayList<Book> findBooksByCategory (String category) throws Exception;
    ArrayList<Book> findBooksByName(String name) throws Exception;
    ...
    String addBook(String title, String first_name, String last_name, int page_number, String price, String image, String category) throws Exception;
    ...
    void changeCategory(int id, String category) throws Exception;


    boolean findMail(String mail) throws Exception;//sprawdz, czy mail jest w bazie
    User checkLogin(String mail, String pass) throws Exception;
